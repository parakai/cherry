...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  't47lypklcirl27aai5tt5a25eu@olmijoxgmjutzrtbonn2dlugaenta33r577d52a@e7lhibzb3zek2c6nvjteepjdtoayr6ja3miud7q@t47lypklcirl2fra56dmmbauie@6dxv7kbetdnkffpviqz6jt7an43h7wlwy7o5jii',
...
async function doHelp() {
  if ($.isNode() && !process.env.PLANT_BEAN_SHARECODES) {
    ...
    $.newShareCode = getRandomArrayElements(jdPlantBeanShareArr.slice(),5);
