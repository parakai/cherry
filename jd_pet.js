...
let shareCodes = [ // IOS本地脚本用户这个列表填入你要助力的好友的shareCode
  ...
  'MTE0MDkyMjIwMDAwMDAwNDc0ODQyNzc=@MTEyNTEyNTE1MDAwMDAwMDA0ODMyOTMyNQ==@MTE0MjI0NTE1MjAwMDAwMDA0NzQ5NDAwNQ==@MTE0MDQ3MzIwMDAwMDAwNDgzNzMxODE=@MTAxNzIyNTU1NDAwMDAwMDA0NzgyOTI4OQ==',
...
async function slaveHelp() {
  ...
  if ($.isNode() && !process.env.PETSHARECODES) {
    ...
    $.newShareCode = getRandomArrayElements(jdPetShareArr.slice(),5);
  } else {
