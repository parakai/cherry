...
let shareCodes = [ // 这个列表填入你要助力的好友的shareCode
  ...
  'b8026c71b4fc42c0bac814079dd211e9@0e16f8d16f7e4c3585646baf671e50d9@ef7f815a929147b0a7f965cc178d64d4@a6e516483d014513b135185e00d712c9@00ef80ceb11c46bdb9c86597c2b575cf',
...
function shareCodesFormat() {
  return new Promise(async resolve => {
    ...
    if ($.isNode() && !process.env.FRUITSHARECODES) {
      ...
      newShareCodes = getRandomArrayElements(jdFruitShareArr.slice(),5);
    }
    // if (!ZLC) {
